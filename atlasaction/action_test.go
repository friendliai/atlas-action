...
func TestMigrateLint(t *testing.T) {
	...
	t.Run("lint summary - lint error", func(t *testing.T) {
		...
		require.Equal(t, "> [!CAUTION]\n"+
			...
			"<!-- generated by friendliai/atlas-action for Add a pre-migration check to ensure table \"t1\" is empty before dropping it -->", comments[0].Body)
	...
	t.Run("lint comment", func(t *testing.T) {
		...
		commentRegex := regexp.MustCompile("<!-- generated by friendliai/atlas-action for [a-zA-Z-]* -->")
		ghMock := httptest.NewServer(http.HandlerFunc(func(writer http.ResponseWriter, request *http.Request) {
			var payload struct {
			...
			case path == "/repos/test-owner/test-repository/issues/42/comments" && method == http.MethodGet:
				comments := `[
            					...
            					{"id": 789, "body": "<!-- generated by friendliai/atlas-action for other-dir-slug -->"}
            				]`
		...
		found := slices.IndexFunc(ghPayloads, func(gh ghPayload) bool {
			...
			return strings.Contains(gh.Body, "generated by friendliai/atlas-action for test-dir-slug")
		})
		...
		found = slices.IndexFunc(ghPayloads, func(gh ghPayload) bool {
			...
			return strings.Contains(gh.Body, "generated by friendliai/atlas-action for other-dir-slug")
		})
		require.NotEqual(t, -1, found)
